  ...
  return (
    <>
      ...
      <p>
        ...
        mismo desde <Link to="/account/privacidad">Ajustes → Privacidad</Link>: descargar
...
function Terminos() {
  return (
    <>
      ...
      <ul>
        <li>Cada plan tiene los límites que ves en <Link to="/planes">Planes</Link> y en la <Link to="/docs/planes">documentación</Link>. Si cambiamos precios o límites te avisaremos antes, y el cambio aplicará a partir de tu siguiente renovación.</li>
        ...
        <li>Usar la API con una clave se paga con créditos que compras antes, según los tokens que consumas y los <Link to="/docs/precios-api">precios publicados</Link>. Solo se cobran los modelos que aparecen en esa tabla.</li>
        ...
        <li>Lo que pasa cuando cancelas o quieres un reembolso está en <Link to="/legal/reembolsos">Cancelaciones y reembolsos</Link>.</li>
      </ul>
