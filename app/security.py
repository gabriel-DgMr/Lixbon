...
from app.config import AUTH_BLOCK_MINUTES, AUTH_RATE_LIMIT, RATE_LIMIT_PER_MIN
from app.db import validate_api_key
...
# ── Rate limiting de autenticación (anti-brute-force por IP) ───────────────

_auth_lock = threading.Lock()
_auth_attempts: dict[str, list[float]] = defaultdict(list)
_auth_blocked: dict[str, float] = {}  # ip -> timestamp de desbloqueo
