...
from core.gateway.routers import admin, admin_panel, attachments, auth, avatar, billing, chat, conversations, installer, keys, nodes_admin, payments, versions, ws_status, monitor
